...
pool.connect(function(err, client, done) {
    ...
    exports.queryFacebook = function(userId, facebookId, facebookToken, firebaseToken){
            ...
            FB.api("/"+facebookId+"/events?type=declined&fields=rsvp_status,attending_count,category,declined_count,interested_count,is_canceled,maybe_count,is_viewer_admin,is_page_owned,noreply_count,place,ticket_uri,type,start_time,end_time,name,description,cover", function (response) {
    ...
    function insertEvents(agendaId, data){
        data.forEach(function(event){
                ...
                var query = "INSERT INTO agenda_events (start_time, end_time, name, more, created_at, updated_at, event_type_id, agenda_id, rsvp_status) VALUES($1, $2, $3, $4, NOW(), NOW(), 'facebook', $5, 'declined') ON CONFLICT ((more->>'facebook_id'), agenda_id) DO UPDATE SET start_time=$1, end_time=$2, name=$3, more=$4, updated_at=NOW(), rsvp_status='declined'";
                console.log(query);
