...
pool.connect(function(err, client, done) {
    ...
    function insertEvents(agendaId, data){
        data.forEach(function(event){
                ...
                var query = "INSERT INTO agenda_events (start_time, end_time, name, more, created_at, updated_at, event_type_id, agenda_id, rsvp_status) VALUES($1, $2, $3, $4, NOW(), NOW(), 'facebook', $5, 'maybe') ON CONFLICT ((more->>'facebook_id'), agenda_id) DO UPDATE SET start_time=$1, end_time=$2, name=$3, more=$4, updated_at=NOW(), rsvp_status='maybe'";
                console.log(query);
